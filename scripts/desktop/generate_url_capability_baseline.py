...
BACKEND = ROOT / "desktop" / "backend" / "app"
TESTS = ROOT / "desktop" / "backend" / "tests"
OUTPUT = ROOT / "desktop" / "backend" / "tests" / "fixtures" / "n01-url-capability-baseline.json"
...
def build_baseline() -> dict[str, object]:
    ...
    return {
        ...
        "generated_from": [
            "desktop/backend/app/services/constant.py",
            "desktop/backend/app/validators/video_url_validator.py",
            "desktop/backend/app/routers/note.py",
            "desktop/backend/app/services/multisource_video_collector.py",
            "desktop/backend/app/services/web_note.py",
            "desktop/backend/tests/**/test_*downloader*.py",
            "desktop/backend/tests/**/test_multisource*.py",
            "desktop/backend/tests/**/test_web_note*.py",
        ],
        "pipeline": {
