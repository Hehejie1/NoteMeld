...
STAGE_DIR="${ROOT_DIR}/desktop/logs/releases/notemeld/${CHANNEL}"
VERSION="$(
...
BASE_URL="${NOTEMELD_RELEASE_BASE_URL:-https://github.com/Hehejie1/NoteMeld/releases/download/v${VERSION}}"
...
if [[ -n "${REMOTE}" ]]; then
  ...
  echo "Set NOTEMELD_RELEASE_REMOTE to an explicitly approved release host to upload."
fi
