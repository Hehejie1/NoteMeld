...
| N04 Link plugin | `./.venv/bin/python -m pytest -q backend/tests/plugins/test_official_link_note.py backend/tests/test_n04_link_capability_matrix.py backend/tests/test_n01_url_capability_baseline.py backend/tests/test_douyin_downloader_contracts.py backend/tests/test_multisource_summary_contracts.py backend/tests/test_multisource_video_collector_contracts.py backend/tests/test_web_note_contracts.py backend/tests/test_core_note_task_status_api.py`；`plugins/official-link-note/release-fixture/official-link-note-1.0.0.zip`；N01→N04 before/after matrix | Passed: 47 tests；7 N01 platforms + web_link covered，before/after rows identical；manifest/index/digest and local Release fixture present | Real network/platform media and N03 installer integration remain for I03/N07 |
