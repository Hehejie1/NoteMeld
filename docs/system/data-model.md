...
Cloud-native command calls are first persisted as `running`, then serialized by
a process-scoped session lock before the provider call and finalized as
