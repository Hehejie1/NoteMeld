...
def create_app(lifespan) -> FastAPI:
    from .routers import agent, chat, config, conversation, imported_notes, ingestion, learning, mcp, migration, model, note, note_style, plugins, provider, usage, whiteboard, wiki
