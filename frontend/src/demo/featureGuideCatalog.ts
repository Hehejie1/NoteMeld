...
export const featureGuideCatalog: Record<string, FeatureGuideEntry> = {
  ...
  'wiki-view-mode': guide('wiki-view-mode', 'Wiki 视图模式', '按知识类型或社区结构组织图谱。', '帮助用户从语义类型和主题聚类两个角度理解知识网络。', 'frontend/src/pages/WikiPage/index.tsx', ['类型视图按节点 type 上色', '社群视图按 community 聚类'], ['WikiGraph nodes/edges/clusters'], '切换只作用于演示图。'),
