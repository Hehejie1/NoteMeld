...
export default function CloudPage() {
  ...
  async function restoreSession(id: string) { await client.restoreSession(id); setListVersion(value => value + 1) }
  async function deleteSession(id: string) { if (window.confirm('Delete this archived session permanently?')) { await client.deleteSession(id); setSelectedId(undefined); setListVersion(value => value + 1) } }
