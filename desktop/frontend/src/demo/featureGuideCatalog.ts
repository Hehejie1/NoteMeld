...
export const featureGuideCatalog: Record<string, FeatureGuideEntry> = {
  ...
  'nav-wiki': guide('nav-wiki', 'Wiki 应用', '查看 NoteMeld 编译出的知识关系图。', '从应用入口继续核验实体、概念、来源和关系。', 'notemeld-applications/apps/wiki', ['打开应用入口', '切换类型/社群视图', '缩放或聚焦节点'], ['applications', 'wiki.read', 'entities', 'concepts', 'sources'], '图数据来自独立 Wiki 应用包，通过 Host Bridge 读取。'),
  ...
  'wiki-view-mode': guide('wiki-view-mode', 'Wiki 视图模式', '按知识类型或社区结构组织图谱。', '帮助用户从语义类型和主题聚类两个角度理解知识网络。', 'notemeld-applications/apps/wiki', ['类型视图按节点 type 上色', '社群视图按 community 聚类'], ['WikiGraph nodes/edges/clusters'], '切换由独立 Wiki 应用包负责。'),
