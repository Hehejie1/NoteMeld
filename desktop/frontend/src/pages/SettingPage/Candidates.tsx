...
import { activateApplicationCandidate, approveCandidate, declineCandidate, listCandidates, validateCandidate, type Candidate } from '@/services/candidates'
