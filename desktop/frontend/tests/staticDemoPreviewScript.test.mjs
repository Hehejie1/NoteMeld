...
const scriptPath = resolve(repositoryRoot, 'scripts/desktop/preview_static_demo.sh')
const packageJsonPath = resolve(repositoryRoot, 'desktop/frontend/package.json')
...
const viteConfig = readFileSync(resolve(repositoryRoot, 'desktop/frontend/vite.config.ts'), 'utf8')
