...
class RemoteFrame:
    ...
    def validate(self) -> None:
        ...
        if type(self.sequence) is not int or type(self.authority_epoch) is not int or self.sequence < 1 or self.authority_epoch < 0 or self.frame_type not in {"command", "receipt", "event", "handshake"}:
